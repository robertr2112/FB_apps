...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should not have the delete link for non-admin users" do
        get :index
      ...
      it "should have the delete link for admin users" do
        test_sign_in(@users.first)
        get :index
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should protect user from deleting themselves" do
        lambda do
